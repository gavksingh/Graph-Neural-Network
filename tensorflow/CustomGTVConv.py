...
class CustomGTVConv(Conv):
    r"""
    A custom graph total variation convolutional layer (CustomGTVConv).
    ...
    **Arguments**
    ...
    - `epsilon`: a small number used to numerically stabilize the computation of new adjacency weights;
    - `activation`: activation function;
    - `use_bias`: boolean, add a bias vector to the output;
    ...
    def _call_single(self, x, a):
        if K.is_sparse(a):
            ...
            # Compute absolute differences between neighboring nodes
